...
print("Signature of Hello world:")
print(signature.hex())
print("")
...
block_sig = sk.sign(block_serialised)
print("Signature of previous block: " + str(block_sig.hex()) )
print("")
block_hash = hashlib.sha256(block_sig).hexdigest()
print("Hit Value: " + str(block_hash[0:16]) )
print("")

hit_value = int(block_hash[0:16],16)

timeToMine = hit_value / (previous_block_header['baseTarget'] * effective_balance)

print("Time to mine: " + str(timeToMine))
